...
public class Card12 implements Comparable<Card12> {
	//ATTRIBUTES
	...
	//CONSTRUCTORS
	public Card12(int number, String type) throws Exception {
	...
	public static Card12 randomCard() throws Exception {
		int number = (int) Math.round(Math.random()*11) +1;
		int type = (int) Math.round(Math.random()*4);
		return new Card12(number, types[type]);
	}
	...
	public boolean equals(Card12 card) {
